...
- **10. Exercises**
  ...
  - P0.3 — Trace and Determinant
  - P0.4 — Norm Equivalence
  - P0.5 — Least Squares from Scratch
  - P0.6 — Matrix Calculus Practice
  - P0.7 — Hessian of a Cubic
  - P0.8 — Testing Positive Semidefiniteness
  - P0.9 — Schur Complement Application
  - P0.10 — Projection onto a Line
  - P0.11 — Projection onto a Hyperplane
  - P0.12 — Orthogonal Complements
  - P0.13 — Frobenius Norm Submultiplicativity
  - P0.14 — Spectral Norm Properties
  - P0.15 — Isometries
  - P0.16 — Loewner Order Transitivity
  - P0.17 — Weighted Inner Product
  - P0.18 — Characterization of Projectors
  - P0.19 — PSD Cone in 2D
  - P0.20 — General Quadratic Minimization
- **11. Readings & Resources**

### Key Elements
- **Theorems/Definitions**: 4
  - Lemma: Quadratic Minimization (Completion of the Square)
  - Lemma: Scalar Matrices
  - Theorem: Invariance under Similarity
  - Lemma: Conjugate of a Norm
- **Proofs**: 29
  - Proof: Preimage Laws
  - Detailed Derivation: Gradient of Quadratic Form
  - Derivation: Gradient of Log Determinant
  - Derivation: Hessian of Least Squares
...
- **9. Exercises**
  ...
  - P1.7 — Pseudoinverse Projectors
  - P1.8 — Projector Formula
  - P1.9 — Hyperplane Projection
  - P1.10 — Condition Number Calculation
  - P1.11 — Pseudoinverse of Rank-1 Matrix
  - P1.12 — Operator Norm Properties
  - P1.13 — Orthogonal Invariance
  - P1.14 — The Orthogonal Group
...
## [04-convex-sets-cones] 04. Convex Sets: Cones and Separation
...
- **4. Exercises**
  ...
  - P4.2 — Dual of a Subspace
  - P4.3 — Self-Duality of Second-Order Cone
  - P4.4 — Dual Cone Identities
  - P4.5 — Generalized Inequality Properties
  - P4.6 — Norm Cone (Epigraph of Norm)
  - P4.7 — Support Function Determines Set
  - P4.8 — Converse Supporting Hyperplane Theorem
  - P4.9 — Cones in $\mathbb{R}^2$
  - P4.10 — Properties of Dual Cones
  - P4.11 — Dual Cone of Generated Cone
  - P4.12 — The Monotone Nonnegative Cone
  - P4.13 — The Lexicographic Cone
  - P4.14 — Dual of Intersection
  - P4.15 — Euclidean Distance Matrices (EDM)
  - P4.16 — SOCP Canonical Dual
  - P4.17 — Homogeneous Envelope and Directional Derivatives
...
- **7. Exercises**
  ...
  - P5.8 — Convexity of Log-Sum-Exp via Cauchy-Schwarz
  - P5.9 — Dual of a Strictly Convex Function
  - P5.10 — Dual via Conjugates
  - P5.11 — Derivation: Dual of QP
  - P5.12 — Sensitivity Analysis using Subgradients
  - P5.13 — Advanced Composition Rules (3.22)
  - P5.14 — Perspective Examples (3.23)
- **8. Recap & What's Next**
...
### Sections
- **Learning Objectives**
- **1. The Convex Conjugate (Fenchel Conjugate)**
